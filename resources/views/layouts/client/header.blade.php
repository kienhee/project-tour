  @php
      $menu = [['name' => 'Trang chủ', 'route' => 'client.index'], ['name' => 'Địa điểm', 'route' => 'client.destination'], ['name' => 'Tour', 'route' => 'client.tour'],['name' => 'Khách sạn', 'route' => 'client.tour'], ['name' => 'Tin tức', 'route' => 'client.blog'], ['name' => 'Liên hệ', 'route' => 'client.contact'], ['name' => 'Về chúng tôi', 'route' => 'client.about-us']];
  @endphp
              ...
              <ul class="navbar-nav ml-auto">
                  ...
                  @if (Auth::check())
                      <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle text-ellipsis" href="#" id="navbarDropdown"
