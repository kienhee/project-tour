                        ...
                        <div class="col-md-12 nav-link-wrap">
                            <div class="nav nav-pills text-center" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link active mr-md-1" id="v-pills-1-tab" data-toggle="pill"
                                    href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true">Tìm kiếm
                                    chuyến đi của bạn</a>
                                                    ...
                                                    <div class="form-field">
                                                        <div class="select-wrap">
                                                            ...
                                                            <select name="price" id="price" class="form-control">
                                                                ...
                                                                <option value="100000" @if (Request()->price ==
                                                                    "100000")
                                                                    @selected(true)
                                                                    @endif>100.000vnd</option>
                                                                <option value="200000" @if (Request()->price ==
                                                                    "200000")
                                                                    @selected(true)
                                                                    @endif>200.000vnd</option>
                                                                <option value="300000" @if (Request()->price ==
                                                                    "300000")
                                                                    @selected(true)
                                                                ...
                                                                <option value="600000" @if (Request()->price ==
                                                                    "600000")
                                                                    @selected(true)
                                                                ...
                                                                <option value="1000000" @if (Request()->price
                                                                    =="1000000" )
                                                                    @selected(true)
                                                                    @endif>1.000.000vnd</option>
                                                                <option value="2000000" @if (Request()->price
                                                                    =="2000000" )
                                                                    @selected(true)
                                                                    @endif>2.000.000vnd</option>
                                                                <option value="3000000" @if (Request()->price
                                                                    =="3000000" )
                                                                    @selected(true)
                                                                    @endif>3.000.000vnd</option>
                                                                <option value="4000000" @if (Request()->price ==
                                                                    "4000000")
                                                                    @selected(true)
                                                                    @endif>4.000.000vnd</option>
                                                                <option value="5000000" @if (Request()->price ==
                                                                    "5000000")
                                                                    @selected(true)
                                                                    @endif>5.000.000vnd</option>
                                                                <option value="6000000" @if (Request()->price ==
                                                                    "6000000")
                                                                    @selected(true)
                                                                    @endif>6.000.000vnd</option>
                                                                <option value="7000000" @if (Request()->price
                                                                    =="7000000" )
                                                                    @selected(true)
                                                                    @endif>7.000.000vnd</option>
                                                                <option value="8000000" @if (Request()->price
                                                                    =="8000000" )
                                                                    @selected(true)
                                                                    @endif>8.000.000vnd</option>
                                                                <option value="9000000" @if (Request()->price ==
                                                                    "9000000")
                                                                    @selected(true)
                                                    ...
                                                    <div class="form-field">
                                                        <div class="select-wrap">
                                                            ...
                                                            <select name="destination" id="destination"
                                                                ...
                                                                <option value="{{$item->id}}" {{ Request()->destination
                                                                    == $item->id
